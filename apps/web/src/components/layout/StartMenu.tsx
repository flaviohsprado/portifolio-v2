...
import { Calculator, FileText, Image, Menu, Power, Settings, Store, User } from "lucide-react";
...
interface StartMenuProps {
   isOpen: boolean;
   onClose: () => void;
   onOpenApp: (id: string, title: string, icon: React.ReactNode, component: React.ReactNode) => void;
}
               ...
               <div className="flex-1 flex">
                  ...
                  <div className="flex-1 py-2">
                     <ScrollArea className="h-148">
                        <div className="mb-6">
                           <h2 className="text-white text-xs font-light mb-4">Recent Added</h2>
                           ...
                           {mappedProjects.map((project) => (
                              <div key={project.id}>
                                 ...
                                 >
                                    ...
                                    <span className="text-xs font-light">{project.name}</span>
                                 </Button>
                              </div>
                           ))}
                        </div>
                     ...
                     <div className="grid grid-cols-1 gap-4">
                        {exploreApps.map((app) => (
                           ...
                           >
                              ...
                              <span className="text-xs text-white font-light">{app.name}</span>
                           </Button>
                        ))}
                     </div>
                  </div>
